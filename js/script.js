$(window).on("load", function () {
    ...
    if($(window).width() < 1280) {
        ...
        $('#pagepiling').pagepiling({
            ...
            anchors: ['home', 'about', 'timeline', 'portfolio', 'sertifikat', 'testimonial', 'contact'],
            scrollingSpeed: 500,
            easing: 'linear',
            loopBottom: false,
            loopTop: false,
            ...
            navigation: {
                'bulletsColor': '#535353',
                'position': 'right',
                'tooltips': ['Home', 'About', 'Career Timeline', 'Portfolio', 'sertifikat', 'Testimonials', 'Contact'],
            },
            //events
